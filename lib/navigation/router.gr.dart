...
class AppRouter extends _i2.RootStackRouter {
  ...
  final Map<String, _i2.PageFactory> pagesMap = {
    MainMenuRoute.name: (routeData) {
      return _i2.MaterialPageX<dynamic>(
          routeData: routeData, child: _i1.MainMenuPage());
    },
  ...
  List<_i2.RouteConfig> get routes => [
        _i2.RouteConfig(MainMenuRoute.name, path: '/'),
        _i2.RouteConfig(DesignPatternDetailsRoute.name, path: '/pattern/:id'),
...
class MainMenuRoute extends _i2.PageRouteInfo<void> {
  const MainMenuRoute() : super(MainMenuRoute.name, path: '/');
...
class DesignPatternDetailsRoute
  ...
  DesignPatternDetailsRoute({required String id})
      : super(DesignPatternDetailsRoute.name,
            path: '/pattern/:id',
